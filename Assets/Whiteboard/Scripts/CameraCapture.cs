...
public class CameraCapture : MonoBehaviour
{
    ...
    private string uniqueFilename(int width, int height)
    {
        ...
        var filename = string.Format("{0}/screen_{1}x{2}_{3}-{4}.{5}", folder, width, height, counter, System.DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss"), format.ToString().ToLower());
